...
export default function Intro() {
  return (
    <>
      <div id="home" className="flex flex-col items-center justify-center mb-10 lg:flex-row lg:p-10">
        <div
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center px-10 pt-20 pb-6 text-center">
            <h1
              className="mb-1 text-4xl font-bold text-transparent md:text-7x1 md:mb-3 dark:text-white bg-gradient-to-r from-blue-800 via-blue-700 to-green-600 bg-clip-text dark:bg-gradient-to-r dark:from-blue-700 dark:via-blue-300 dark:to-green-400 text-gradient"
            >
              Olá, me chamo Gabriel Francisco
            </h1>
            <h3
              className="text-base font-bold text-transparent md:text-xl my-7 lg:text-2xl bg-gradient-to-r from-blue-800 via-blue-700 to-green-600 bg-clip-text dark:bg-gradient-to-r dark:from-blue-700 dark:via-blue-300 dark:to-green-400 text-gradient"
            >
              <TypeAnimation
                className="text-2xl"
                sequence={[
